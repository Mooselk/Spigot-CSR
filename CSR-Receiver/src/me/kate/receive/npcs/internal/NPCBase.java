...
import me.kate.receive.math.MathUtil;
import me.kate.receive.npcs.NPCLib;
import me.kate.receive.npcs.api.NPC;
import me.kate.receive.npcs.api.events.NPCHideEvent;
import me.kate.receive.npcs.api.events.NPCShowEvent;
...
public abstract class NPCBase implements NPC, NPCPacketHandler {
    ...
    protected String npcID = uuid.toString().replace("-", "").substring(0, 10);
    protected String name = "nullName :(";
    ...
    public NPCBase(NPCLib instance, String name) {
